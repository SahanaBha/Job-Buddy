...
<footer id="contactus" style="background-color: #272727;">
    <div class="container" style="width: 100%;">
				<div class="row justify-content-center">
                    ...
                    <a href="mailto: jobvio@gmail.com" style="color: #ffd6a5; padding-top: 50px; font-family:Comfortaa;"> CONTACT </a>
                    </p>
                    </div>
                ...
                <div class="row mt-5">
					<div class="col-md-12 text-center">
						<p class="copyrigt">
                        <a style="color: #9FA4A9; text-decoration: none;"> All rights reserved 2024 | Developed by </a> 
                        <a href="https://www.linkedin.com/in/sahana-bhaskar-4546a71b7" style="color: #FDFFAC;">Sahana Bhaskar</a> 
                        <a style="color: #FDFFAC; text-decoration: none;">&</a> 
                        <a href="https://www.linkedin.com/in/saanvi-p-gowda-900b61247" style="color: #FDFFAC;">Saanvi P Gowda</a> 
					    </p>
					</div>
				</div>
    </div>
